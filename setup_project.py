...
# Função para criar as pastas do projeto
def criar_estrutura():
    estrutura = [
        'projeto_tabela_regionais/assets/css',
        'projeto_tabela_regionais/assets/js',
        'projeto_tabela_regionais/data',
        'projeto_tabela_regionais/templates'
    ]
    ...
    with open('projeto_tabela_regionais/app.py', 'w') as f:
        f.write("""
import pandas as pd
...
# Chamar a função para criar a estrutura do projeto
criar_estrutura()
